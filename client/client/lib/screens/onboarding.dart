...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  final List<Map<String, String>> _pages = [
    ...
    {"title": "Welcome aboard", "desc": "We're glad you're here. Let's begin your journey.", "img": "assets/onboarding2.jpg"},
    {"title": "Vision Mapping", "desc": "Define Your Vision", "img": "assets/onboarding3.png"},
    {"title": "You're all set!", "desc": "Let's dive in and explore what's waiting for you.", "img": "assets/onboarding5.jpg"},
  ];
  ...
  Widget _buildPage(int i) {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          _pages[i]['title']!,
          style: TextStyle(fontSize: isFirstPage ? 36 : 28, fontWeight: FontWeight.bold, color: Colors.white),
        ),
        if (!isFirstPage) ...[
  ...
  Widget _buildDots() {
    return Row(
      ...
      children: List.generate(_pages.length, (idx) => Container(
        ...
        decoration: BoxDecoration(
          color: idx == _currentPage ? const Color(0xFF4CAF50) : Colors.white24,
